    ...
    <div className='md:w-64 w-16 border-r h-full text-base border-gray-500 pt-4 flex flex-col transition-all duration-300'>
      {sideBarLinks.map((item, index) => (
        <NavLink to={item.path} key={index} end='/owner'
          className={({ isActive }) => `flex items-center py-4 px-5 md:px-10 gap-3 ${isActive ? "border-r-4 md:border-r-[6px] bg-blue-600/10 border-blue-600 text-blue-600" : "hover:bg-gray-100/90 border-white text-gray-700"}`}>
